                      ...
                      <div class="flex flex-col md:flex-row -mx-4 mt-3">
                        <div class="md:flex-1 px-4">
                          <div class="h-[460px] rounded-lg bg-gray-300 dark:bg-gray-700 mb-4">
                            <img class="w-full h-full object-fit" src={selectedProduct.image} alt="Product Image"></img>
                          </div>
                          ...
                          <p>
                            <div class="flex mt-5 mb-4">
                              <div class="w-1/2 px-2">
                                <p onClick={() => addtocart(selectedProduct)} class="w-full cursor-pointer text-center bg-gray-900 dark:bg-gray-600 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-gray-700">Add to Cart</p>
                              </div>
